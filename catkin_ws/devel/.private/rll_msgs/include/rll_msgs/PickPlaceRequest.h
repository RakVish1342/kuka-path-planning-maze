...
bool operator==(const ::rll_msgs::PickPlaceRequest_<ContainerAllocator1> & lhs, const ::rll_msgs::PickPlaceRequest_<ContainerAllocator2> & rhs)
{
  return lhs.pose_above == rhs.pose_above &&
    lhs.pose_grip == rhs.pose_grip &&
    lhs.gripper_close == rhs.gripper_close &&
    lhs.grasp_object == rhs.grasp_object;
}
