...
class JobEnvAction(genpy.Message):
  _md5sum = "966bfb736b38331bbc418c75de196f02"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.authentication_secret
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.client_ip_addr
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.authentication_secret = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.authentication_secret = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.client_ip_addr = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.client_ip_addr = str[start:end]
      _x = self
      start = end
      end += 12
