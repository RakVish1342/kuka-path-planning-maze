...
bool operator==(const ::rll_planning_project::CheckPathResponse_<ContainerAllocator1> & lhs, const ::rll_planning_project::CheckPathResponse_<ContainerAllocator2> & rhs)
{
